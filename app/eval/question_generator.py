...
def generate_eval_questions(llm: ChatOpenAI, *, count: int = 20) -> EvaluationQuestionSet:
    if count <= 0:
    ...
    if len(questions) != count:
        raise ValueError(f"Generator returned {len(questions)} questions, expected {count}.")
